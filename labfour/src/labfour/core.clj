...
(defn -main [& args]
  (println "Testing Expr->DNF conversion")
  (println (convert-to-dnf (op-and (op-or (variable :x) (variable :y)) (op-or (variable :a) (variable :b)))))
  (println "Testing bool evaluation")
  (println (evaluate-expr (op-and (op-or (variable :x) (variable :y)) (op-or (variable :a) (variable :b)))
